...
class Page_PageController extends KontorX_Controller_Action_CRUD {
    public $skin = array(
		'layout' => 'admin_page',
		'config' => array(
    ...
    protected $_modelClass = 'Page';

    protected $_configFilenameExtension = 'xml';

    protected $_addPostObservableName = 'page_page_add_post';
	protected $_editPostObservableName = 'page_page_edit_post';
	protected $_deletePostObservableName = 'page_page_delete_post';

    public function init() {
        $language = $this->_getParam('language_url', 'pl');
        $this->_setParam('language_url', $language);
        parent::init();
    }
