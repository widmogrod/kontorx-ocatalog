<?php
class Catalog_SearchfindController extends Promotor_Controller_Action_Scaffold {
	 ...
	 */
	protected $_modelClass = 'Catalog_Model_SearchFind';
	protected $_formAddClass = 'Catalog_Form_SearchFindAdd';
	protected $_formEditClass = 'Catalog_Form_SearchFindEdit';
	protected $_formRemoveClass = 'Catalog_Form_SearchFindRemove';
	
//	protected $_addPostObservableName = 'catalog_search_find_add_post';
//	protected $_editPostObservableName = 'catalog_search_find_edit_post';
//	protected $_deletePostObservableName = 'catalog_search_find_delete_post';
	...
	public function listAction() {
		$model = new Catalog_Model_SearchFind();
...
//						}
		...
		// setup data grid
		$config = $this->_helper->config('searchfind.xml');
