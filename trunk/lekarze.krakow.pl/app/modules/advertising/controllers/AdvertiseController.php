...
class Advertising_AdvertiseController extends KontorX_Controller_Action_CRUD {
    ...
    protected $_modelClass = 'AdvertisingAdvertise';
    ...
    public function listAction() {
        ...
        $config = $this->_helper->config('advertise.xml');
